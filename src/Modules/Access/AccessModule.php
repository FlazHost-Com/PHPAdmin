...
class AccessModule
{
    ...
    private function registerWebRoutes(RouteCollector $r, RouteRegistry $registry): void
    {
        ...
        $r->addRoute('GET',  '/admin/v1/access/role/{id}/permission',
        ...
        $r->addRoute('GET',  '/admin/v1/access/role/{id}/permission/{permission_id}/assign',
            [RoleController::class, 'assignPermission']);
        $registry->register('admin.v1.access.role.permission.assign', 'GET',
            '/admin/v1/access/role/{id}/permission/{permission_id}/assign');

        $r->addRoute('POST', '/admin/v1/access/role/{id}/permission/assign_selected',
            [RoleController::class, 'assignSelected']);
        $registry->register('admin.v1.access.role.permission.assign_selected', 'POST',
            '/admin/v1/access/role/{id}/permission/assign_selected');

        $r->addRoute('GET',  '/admin/v1/access/role/{id}/permission/{permission_id}/unassign',
            [RoleController::class, 'unassignPermission']);
        $registry->register('admin.v1.access.role.permission.unassign', 'GET',
            '/admin/v1/access/role/{id}/permission/{permission_id}/unassign');

        $r->addRoute('POST', '/admin/v1/access/role/{id}/permission/unassign_selected',
            [RoleController::class, 'unassignSelected']);
        $registry->register('admin.v1.access.role.permission.unassign_selected', 'POST',
            '/admin/v1/access/role/{id}/permission/unassign_selected');

        // ── Permission ────────────────────────────────────────────────────────
        $r->addRoute('GET',    '/admin/v1/access/permission',
            [PermissionController::class, 'index']);
        $registry->register('admin.v1.access.permission.index', 'GET', '/admin/v1/access/permission');

        $r->addRoute('GET',    '/admin/v1/access/permission/create',
        ...
        $r->addRoute('DELETE', '/admin/v1/access/permission/{id}/delete',
        ...
        $r->addRoute('POST',   '/admin/v1/access/permission/delete_selected',
            [PermissionController::class, 'deleteSelected']);
        $registry->register('admin.v1.access.permission.delete_selected', 'POST',
            '/admin/v1/access/permission/delete_selected');

        $r->addRoute('GET',    '/admin/v1/access/permission/sync',
    ...
    private function registerApiRoutes(RouteCollector $r, RouteRegistry $registry): void
    {
        ...
        // Role permission API
        $r->addRoute('GET',  '/api/v1/access/role/{id}/permission',
        ...
        $r->addRoute('DELETE', '/api/v1/access/permission/{id}/delete',
        ...
        $r->addRoute('POST',   '/api/v1/access/permission/delete_selected',
            [PermissionController::class, 'apiDeleteSelected']);
        $registry->register('api.v1.access.permission.delete_selected', 'POST',
            '/api/v1/access/permission/delete_selected');

        $r->addRoute('POST',   '/api/v1/access/permission/sync',
